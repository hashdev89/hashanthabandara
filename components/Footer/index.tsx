      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        href="https://forms.gle/we5BCx4khdYS9Tqt6"
                        className="mb-3 inline-block hover:text-primary"
                      >
                        Start a project
                      </a>
                ...
                <p>
                  <a href="mailto:hello@hashanthabandara.com">hello@hashanthabandara.com</a>
                </p>
                  <br></br>
                <h5 className="mb-4 text-metatitle3 font-medium text-black dark:text-white">
                  Phone Number
                ...
                <p>
                <a href="tel:+94769212943">+94 769 212 943</a></p>
                </motion.div>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Hashantah Bandara . All rights reserved
              </p>
            </motion.div>
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a href="https://web.facebook.com/hashwic1989" aria-label="social icon">
                    <svg
                ...
                <li>
                  <a href="https://www.linkedin.com/in/hashanthawickramasinghe/" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
                ...
                <li>
                  <a href="https://www.behance.net/hashantnayanaj" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
