          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join With Me on Linkdin
              </h2>
              <p>
              Feel free to connect with me on LinkedIn! I'm always open to discussing new opportunities, sharing insights, and expanding my professional network. Let’s stay in touch and explore how we can collaborate.
              </p>
            </motion.div>
            <motion.div
              variants={{
            ...
            >
              <div className="flex items-center justify-end xl:justify-between">
                ...
                />
                <a
                  href="https://www.linkedin.com/in/hashanthawickramasinghe/"
